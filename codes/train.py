...
def main():
    ...
    parser.add_argument('-opt', type=str, default='options/train/train_ORDSRNet.yml', help='Path to option YAML file.')
    ...
    # flops, params = get_model_complexity_info(model.netG, (1, 224//4, 224//4), as_strings=True, print_per_layer_stat=True)
